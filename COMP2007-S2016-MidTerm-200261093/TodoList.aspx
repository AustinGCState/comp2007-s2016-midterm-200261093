            ...
            <div class="col-md-offset-2 col-md-8">
               ...
               <div>
                ...
                <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover" ID="TodoGridview" AutoGenerateColumns="false" DataKeyNames="TodoID" OnRowDeleting="TodoGridview_RowDeleting"
                     AllowPaging="true" OnPageIndexChanging="TodoGridview_PageIndexChanging" AllowSorting="true" OnSorting="TodoGridview_Sorting" OnRowDataBound="TodoGridview_RowDataBound">
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="<i class='fa fa-pencil-square-o fa-lg'></i> Edit" NavigateUrl="~/TodoDetails.aspx" ControlStyle-CssClass="btn btn-primary btn-sm" runat="server" DataNavigateUrlFields="TodoID" DataNavigateUrlFormatString="TodoDetails.aspx?TodoID=(0)"/>
